...
api_v1_router.include_router(job_group.router, tags=["admin/job_group"], prefix="/admin")
api_v1_router.include_router(department.router, tags=["admin/department"], prefix="/admin")
